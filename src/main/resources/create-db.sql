--DROP TABLE ResourceExperiments IF EXISTS;
--DROP TABLE AxiomExperiments IF EXISTS;
--DROP TABLE ClassExperiments IF EXISTS;
--DROP TABLE Users IF EXISTS;
--DROP TABLE Triples IF EXISTS;
--DROP TABLE Resources IF EXISTS;
--DROP TABLE InstanceTriples IF EXISTS;
--DROP TABLE Instances IF EXISTS;
--DROP TABLE Axioms IF EXISTS;
...
CREATE TABLE IF NOT EXISTS Instances (
    id INT GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) PRIMARY KEY,
    instanceOf INT FOREIGN KEY REFERENCES Axioms(id) NOT NULL,
    name VARCHAR(500) NOT NULL,
    correctInstance BIT NOT NULL
);

CREATE TABLE IF NOT EXISTS InstanceTriples (
    id INT GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) PRIMARY KEY,
    tripleOf INT FOREIGN KEY REFERENCES Instances(id),
    overheadTripleOf INT FOREIGN KEY REFERENCES Axioms(id),
