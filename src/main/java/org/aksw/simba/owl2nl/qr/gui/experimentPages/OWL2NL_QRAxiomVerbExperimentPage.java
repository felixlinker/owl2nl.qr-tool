...
public class OWL2NL_QRAxiomVerbExperimentPage extends OWL2NL_QRExperimentPage<OWL2NL_QRAxiomVerbExperimentSetup> {
    ...
    public static void addInstructionsParagraphsStatic(HtmlContainer container) {
        ...
        container.addElement(new Paragraph("Adequacy means how well the axiom was verbalized in regards to the actual axiom. Is every information verbalized? Is there anything missing? Does the verbalization reflect the axiom?"));
